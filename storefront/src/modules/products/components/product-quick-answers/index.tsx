...
const ProductQuickAnswers = ({
  ...
  return (
    <section className="rounded-md border border-ui-border-base bg-grey-5 p-5 small:p-6">
      <div className="flex flex-col gap-6">
        <div className="grid grid-cols-1 large:grid-cols-[minmax(0,1fr)_280px] gap-6">
          ...
          <div className="rounded-md border border-ui-border-base bg-white p-4">
            <Text className="text-base-semi text-ui-fg-subtle mb-2">
              Still unsure?
            </Text>
            ...
            >
              <Button className="w-full bg-brand-600 hover:bg-grey-10 border-none">
                Request review
              </Button>
            </LocalizedClientLink>
          </div>
        ...
        <div className="grid grid-cols-1 medium:grid-cols-2 large:grid-cols-4 gap-3">
          {answers.map((answer) => (
            <a
              key={answer.title}
              href={answer.href}
              className="rounded-md border border-ui-border-base bg-white p-4 hover:border-brand-300"
            >

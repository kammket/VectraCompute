...
import BitcoinPaymentDetails from "@modules/checkout/components/bitcoin-payment-details"
...
const Payment = ({
  ...
  const getPaymentTitle = (providerId?: string) => {
    if (isManual(providerId) && bitcoinPaymentSettings?.enabled) {
      return bitcoinPaymentSettings.activeMode === "btcpay"
        ? "Bitcoin via BTCPay"
                ...
                >
                  ...
                  <Text>
                    {isStripeLike(selectedPaymentMethod) && cardBrand
                      ? cardBrand
                      : bitcoinPaymentSettings?.enabled &&
                        isManual(selectedPaymentMethod)
                      ? "BTC instructions shown at review and confirmation"
                      : "Admin will confirm payment details"}
                  </Text>
                </div>
              </div>
            </div>
